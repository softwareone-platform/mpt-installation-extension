...
from mpt_installation_extension.routers.events.agreement import (
    agreements_router as events_agreements_router,
)
from mpt_installation_extension.routers.events.order import orders_router as events_orders_router
from mpt_installation_extension.routers.plugs.agreements import (
